...
# CORS_ALLOWED_ORIGINS = ['http://7trans.by']
...
MEDIA_ROOT = 'https://7trans.by/public_html/media/'

STATICFILES_DIRS = [os.path.join(BASE_DIR, 'config', 'static/')]

DEFAULT_AUTO_FIELD = 'django.db.models.BigAutoField'

NEWS_INDEX_PAGE_FIRST_ARTICLE_TITLE_LENGTH = 140
NEWS_INDEX_PAGE_FIRST_ARTICLE_PREVIEW_BODY_LENGTH = 80
NEWS_INDEX_PAGE_SECOND_ARTICLE_TITLE_LENGTH = 44
NEWS_INDEX_PAGE_SECOND_ARTICLE_PREVIEW_BODY_LENGTH = 80
NEWS_INDEX_PAGE_THIRD_ARTICLE_TITLE_LENGTH = 44
NEWS_INDEX_PAGE_THIRD_ARTICLE_PREVIEW_BODY_LENGTH = 80

SERVICES_PAGE_SERVICE_CONTENT_LENGTH = 100
