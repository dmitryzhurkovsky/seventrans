...
def modify_len_title_and_body_of_news(news: QuerySet) -> list:
    ...
    first_article['preview_body'] = first_article.get('body')[:settings.NEWS_INDEX_PAGE_FIRST_ARTICLE_PREVIEW_BODY_LENGTH]

    second_article['title'] = second_article.get('title')[:settings.NEWS_INDEX_PAGE_SECOND_ARTICLE_TITLE_LENGTH]
    second_article['preview_body'] = second_article.get('body')[:settings.NEWS_INDEX_PAGE_SECOND_ARTICLE_PREVIEW_BODY_LENGTH]
